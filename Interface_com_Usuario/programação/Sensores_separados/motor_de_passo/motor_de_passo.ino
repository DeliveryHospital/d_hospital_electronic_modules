...
#define MOTOR_PHASE_A_D           4                                  // motor phase a pin
#define MOTOR_PHASE_B_D           16                                  // motor phase b pin
#define MOTOR_PHASE_C_D           15                                 // motor phase c pin
#define MOTOR_PHASE_D_D            2                                  // motor phase d pin

#define MOTOR_PHASE_A_E           33                                  // motor phase a pin
#define MOTOR_PHASE_B_E           32                                  // motor phase b pin
#define MOTOR_PHASE_C_E           26                                  // motor phase c pin
#define MOTOR_PHASE_D_E           25                                  // motor phase d pin

#define STEPS_PER_REVOLUTION    40096                                // steps for one full revolution of the stepper
...
void setup() 
{
  ...
  // I/O.
    ...
    pinMode(MOTOR_PHASE_A_D, OUTPUT);
    pinMode(MOTOR_PHASE_B_D, OUTPUT);
    pinMode(MOTOR_PHASE_C_D, OUTPUT);
    pinMode(MOTOR_PHASE_D_D, OUTPUT);
    
    pinMode(MOTOR_PHASE_A_E, OUTPUT);
    pinMode(MOTOR_PHASE_B_E, OUTPUT);
    pinMode(MOTOR_PHASE_C_E, OUTPUT);
    pinMode(MOTOR_PHASE_D_E, OUTPUT);
...
void  MotorOff()
{
  digitalWrite(MOTOR_PHASE_A_D, LOW);
  digitalWrite(MOTOR_PHASE_B_D, LOW);
  digitalWrite(MOTOR_PHASE_C_D, LOW);
  digitalWrite(MOTOR_PHASE_D_D, LOW);
  
  digitalWrite(MOTOR_PHASE_A_E, LOW);
  digitalWrite(MOTOR_PHASE_B_E, LOW);
  digitalWrite(MOTOR_PHASE_C_E, LOW);
  digitalWrite(MOTOR_PHASE_D_E, LOW);
}
...
void  Step(int nDirection)
{
  ...
  switch(nPhase)
  {
    case 0:
    {
      digitalWrite(MOTOR_PHASE_D_D, HIGH);
      digitalWrite(MOTOR_PHASE_C_D, LOW);
      digitalWrite(MOTOR_PHASE_B_D, LOW);
      digitalWrite(MOTOR_PHASE_A_D, LOW);
      
      digitalWrite(MOTOR_PHASE_D_E, HIGH);
      digitalWrite(MOTOR_PHASE_C_E, LOW);
      digitalWrite(MOTOR_PHASE_B_E, LOW);
      digitalWrite(MOTOR_PHASE_A_E, LOW);
    }
    ...
    {
      digitalWrite(MOTOR_PHASE_D_D, HIGH);
      digitalWrite(MOTOR_PHASE_C_D, HIGH);
      digitalWrite(MOTOR_PHASE_B_D, LOW);
      digitalWrite(MOTOR_PHASE_A_D, LOW);
      
      digitalWrite(MOTOR_PHASE_D_E, LOW);
      digitalWrite(MOTOR_PHASE_C_E, LOW);
      digitalWrite(MOTOR_PHASE_B_E, HIGH);
      digitalWrite(MOTOR_PHASE_A_E, HIGH);
    }
    break;
    ...
    case 3:
    {
      digitalWrite(MOTOR_PHASE_D_D, LOW);
      digitalWrite(MOTOR_PHASE_C_D, HIGH);
      digitalWrite(MOTOR_PHASE_B_D, HIGH);
      digitalWrite(MOTOR_PHASE_A_D, LOW);

      digitalWrite(MOTOR_PHASE_D_E, LOW);
      digitalWrite(MOTOR_PHASE_C_E, HIGH);
      digitalWrite(MOTOR_PHASE_B_E, HIGH);
      digitalWrite(MOTOR_PHASE_A_E, LOW);
    }
    break;
    ...
    case 5:
    {
      ...
      digitalWrite(MOTOR_PHASE_C_D, LOW);
      digitalWrite(MOTOR_PHASE_B_D, HIGH);
      digitalWrite(MOTOR_PHASE_A_D, HIGH);
